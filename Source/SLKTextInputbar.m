...
- (void)slk_commonInit
{
    ...
    [self setBackgroundColor:[UIColor colorWithRed:226.0/255.0 green:226.0/255.0 blue:226.0/255.0 alpha:1]];
}
...
- (void)layoutSubviews
{
        ...
        [self bringSubviewToFront:self.leftButton2];
...
//    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(7)-[leftButton(0)]-(7)-|" options:0 metrics:metrics views:views]];
//    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(>=0)-[leftButton2]-(<=0)-|" options:0 metrics:metrics views:views]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton2 attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:nil multiplier:1 constant:37]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:nil multiplier:1 constant:37]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton2 attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:nil multiplier:1 constant:37]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.leftButton2 attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:nil multiplier:1 constant:37]];
    
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(>=7)-[rightButton]-(<=7)-|" options:0 metrics:metrics views:views]];
    ...
    self.leftMargin2WC = [self slk_constraintsForAttribute:NSLayoutAttributeLeading][0];
