...
@property (nonatomic, strong) NSLayoutConstraint *bottomMiddleMarginWC;
...
- (void)slk_setupViewConstraints
{
    ...
    self.bottomMiddleMarginWC = [self slk_constraintForAttribute:NSLayoutAttributeBottom firstItem:self secondItem:self.middleButton];
...
- (void)slk_updateConstraintConstants
{
    ...
    if (self.isEditing)
    {
        ...
        self.bottomMiddleMarginWC.constant = zero;
        ...
        if (leftButtonSize.width > 0) {
            ...
            self.bottomMiddleMarginWC.constant = self.bottomMarginWC.constant;
        }
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    else if ([object isEqual:self.middleButton.imageView] && [keyPath isEqualToString:NSStringFromSelector(@selector(image))]) {
